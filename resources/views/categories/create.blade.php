                                    ...
                                    <form action="{{ route('categorie.post') }}" method="POST">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="name" class="form-control" id="title" placeholder="Economie"
                                                    value="{{ old('name') }}">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" name="overview" class="form-control" id="overview" placeholder="inserez une description"
                                                    value="{{ old('overview') }}">
                                            </div>
                                        </div>
